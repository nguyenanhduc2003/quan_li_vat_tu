...
//xác nhận
function confirmReceived(rowId) {
    if (confirm("Bạn có chắc chắn muốn xác nhận vật tư này?")) {
        // Thay đổi nội dung nút thành 'Đã xác nhận'
        document.getElementById("btn" + rowId).textContent = "Đã xác nhận";
        document.getElementById("btn" + rowId).classList.remove("btn-success");
    }
}
